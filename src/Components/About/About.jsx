          ...
          <div className="containerAbout">
            <div className="section__description">
              <p className="section__description">
                ...
                presence from the ground up - from concept, navigation and
                layout. Skilled in Front End technologies such as Html5 , Css3 ,
                JavaScript , React ,Angular, Sass, and Back End technologies
                such as Node.JS, Express JS and MongoDb. Learning a variety of
